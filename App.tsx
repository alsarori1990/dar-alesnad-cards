...
const CompanyLogo: React.FC<{ className?: string }> = ({ className }) => <svg className={className} viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg"><path fill="#4338ca" d="M50 10 A 40 40 0 1 0 50 90 A 40 40 0 1 0 50 10 Z M 50 20 A 30 30 0 1 1 50 80 A 30 30 0 1 1 50 20 Z" /><text x="50" y="55" fontFamily="Cairo, sans-serif" fontSize="20" fill="white" textAnchor="middle">DA</text></svg>;
    ...
    return (
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <header className="py-12 sm:py-16 text-center">
                <CompanyLogo className="w-20 h-20 mx-auto mb-4"/>
                <h1 className="text-4xl sm:text-5xl font-extrabold text-slate-900 tracking-tight">بطاقات تهنئة دار الإسناد</h1>
        ...
        <div className="flex items-center justify-center min-h-full p-4">
            <div className="w-full max-w-md p-8 space-y-6 bg-white rounded-2xl shadow-2xl shadow-slate-300/60 border border-slate-200/80">
                 <div className="text-center">
                    <CompanyLogo className="w-16 h-16 mx-auto mb-2"/>
